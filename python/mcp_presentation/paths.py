"""On-disk layout helpers: projects/*.git and workspaces/*."""
...
ROOT = Path(os.environ.get("MCP_PRESENTATION_ROOT", ".")).resolve()
PROJECTS_DIR = Path(os.environ.get("MCP_PRESENTATION_PROJECTS", str(ROOT / "projects")))
WORKSPACES_DIR = Path(os.environ.get("MCP_PRESENTATION_WORKSPACES", str(ROOT / "workspaces")))
