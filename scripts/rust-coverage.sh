...
FAIL_UNDER="${RUST_COV_FAIL_UNDER:-98}"
...
CRATES=(
  "$ROOT|mcp-presentation-core"
  "$ROOT/packages/mcp-presentation-state|mcp-presentation-state"
  "$ROOT/packages/mcp-presentation-git|mcp-presentation-git"
  "$ROOT/packages/mcp-presentation-docker|mcp-presentation-docker"
)
